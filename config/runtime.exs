...
#
#     PHX_SERVER=true bin/ex_wallet start
#
# Alternatively, you can use `mix phx.gen.release` to generate a `bin/server`
# script that automatically sets the env var above.
if System.get_env("PHX_SERVER") do
  config :ex_wallet, ExWalletWeb.Endpoint, server: true
end
...
if config_env() == :prod do
  database_path =
    System.get_env("DATABASE_PATH") ||
      ...
      For example: /etc/ex_wallet/ex_wallet.db
      """
  ...
  config :ex_wallet, :dns_cluster_query, System.get_env("DNS_CLUSTER_QUERY")

  config :dns_cluster, log_level: :error
  ...
  #
  #     config :ex_wallet, ExWallet.Mailer,
